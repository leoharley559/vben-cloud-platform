...
| 主应用 | `apps/web-antd` |
| **改版方案** | **[cloudPlatform改版方案.md](./cloudPlatform改版方案.md)**（迁移路线图、模块清单、分工） |
| 开发规范 | **[模版使用说明.md](./模版使用说明.md)**（目录规范、API 配置、升级步骤） |
...
```bash
git clone git@github-leoharley559:leoharley559/vben-cloud-platform.git
cd vben-cloud-platform
