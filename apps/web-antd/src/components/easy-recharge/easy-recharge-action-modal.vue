...
import {
  confirmEasyRechargeApi,
  reviewEasyRechargeApi,
} from '#/api/operationManage/easy-recharge';

defineOptions({ name: 'EasyRechargeActionModal' });
  ...
  >
    <Form layout="vertical">
      ...
      <Form.Item label="确认金额" required>
        <Input v-model:value="confirmAmount" placeholder="请输入确认金额" />
      </Form.Item>
    </Form>
  </Modal>
</template>
