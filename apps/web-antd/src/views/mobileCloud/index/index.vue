...
<template>
  <MobileShell v-model:active-tab="activeTab" :tabs="MOBILE_CLOUD_TABS">
    <VerifyCodePanel v-if="activeTab === 'code'" />
    <MemberPanel v-else-if="activeTab === 'member'" />
    <UserPanel v-else-if="activeTab === 'user'" />
  </MobileShell>
</template>
