...
const canViewTable = computed(() => checkPermission(11_659));
const canBatchApprove = computed(() => checkPermission(11_660));
const canBatchReject = computed(() => checkPermission(11_661));
